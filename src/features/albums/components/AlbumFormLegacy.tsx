/**
 * Legacy Album Form Component - Backup
 * This is the previous modular version before wizard enhancement
 */
"use client";
...
export function AlbumFormLegacy({
  mode,
  initialData = {},
  onSave,
  loading = false,
...
export default AlbumFormLegacy;
